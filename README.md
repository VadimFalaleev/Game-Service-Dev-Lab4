...
- Выполнив лабораторную работу 4 по разработке игровых сервисов, я закрепил умения работы с анимациями, интерфейсом и ассетами, создал стартовое меню, задал функционал кнопкам и реализовал переключение между сценами. Добавил на уровень персонажа, работал со звуками, музыкой и световыми эффектами, сделал паузу в игре. Во втором задании расписал, как происходит сборка проекта и указал на некоторые особенности. В третьем задании создал настройку громкости фоновой музыки.
